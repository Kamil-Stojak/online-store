...
function imionka3($imie,$nazwisko,$telefon,$kodpocztowy,$kraj,$miejscowość,$adres){
    if(empty($imie) || empty($nazwisko)|| empty($telefon)|| empty($kodpocztowy)|| empty($kraj)|| empty($miejscowość)|| empty($adres)){
        $result=true;
    }
    else{
        $result=false;
